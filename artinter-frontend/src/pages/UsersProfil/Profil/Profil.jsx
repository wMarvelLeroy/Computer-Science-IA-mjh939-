...
import { faUsers, faAward, faFileLines, faCommentDots, faHeart, faArrowTrendUp, faChartSimple } from '@fortawesome/free-solid-svg-icons';
              ...
              <div className="demande-status">
                ...
                {demande.statut === 'en_attente' && (
                  <div className="status-message info">
                    <p>⏳ Votre demande est en cours d'examen par notre équipe.</p>
                ...
                {demande.statut === 'refusee' && (
                  <div className="status-message error">
                    ...
                    <p className="small">Vous pouvez soumettre une nouvelle demande après avoir pris en compte les remarques.</p>
                  </div>
                )}
